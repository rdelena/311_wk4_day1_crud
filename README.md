...
3. All three DELETES
<!-- Deleted starting from the children tables (usersContact & usersAddress) then deleted from users. Used disable safe mode in MySQL Workbench in preferences to combat Error. -->
